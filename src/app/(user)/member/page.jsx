...
const Member = () => {
  return (
    <div>
      ...
      <section>
        <PageEndQuery heading={`Interested in Becoming a Member?`} subheading={`Click the register button below to see the procedures`} button={{ title: "Register Now", path:'/registration' }} />
