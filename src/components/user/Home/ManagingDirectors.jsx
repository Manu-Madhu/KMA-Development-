...
function ManagingDirectors() {
  return (
    <div className="max-w-screen-xl mx-auto w-full p-3 flex flex-col items-center mt-10 lg:t-20 pb-10">
      ...
      <div className="grid grid-cols-6 max-sm:grid-cols-2 max-lg:grid-cols-4 gap-2 sm:gap-4 w-full lg:mt-7">
