...
function ProfileCard({ name, role, image }) {
  return (
    ...
    //   data-aos-duration="1000"
      className="h-[200px] lg:h-[225px] w-full rounded-2xl overflow-hidden border border-gray-300"
    >
      ...
      <div className="h-[30%] p-3 rounded-b-2xl ">
        <h1 className="font-[550] lg:mt-0 lg:text-sm">{name}</h1>
        <p className="text-[11px] lg:mt-1">{role}</p>
      </div>
    </div>
  );
}
