...
console.log({newData})
    ...
    return (
        <div className='w-full h-[100vh] bg-[#000000] relative flex flex-col items-center '>
            ...
            <h1 className='tracking-[10px] sm:tracking-[50px] text-white text-[60px] sm:text-[120px] xl:text-[200px] font-light
            absolute bottom-[10vh] xl:top-[26vh] z-40'> {rotated[0]?.year} </h1>
            ...
            <div className=' hidden w-fit h-fit sm:flex flex-col items-center gap-4 absolute sm:left-[8vw] top-[26vh] blur-[1px] z-20 '>
                ...
                <p className=' text-white w-[30ch] text-center'> {rotated[1]?.title} </p>
            </div>


            <div className='hidden w-fit h-fit sm:flex flex-col items-center gap-4 absolute sm:right-[30vw] top-[34vh]  blur-[2px] z-10 '>
                <Image 
                src={rotated[2]?.image}
                alt='image'
                ...
                <p className=' text-white w-[30ch] text-center'> {rotated[2]?.title} </p>
            </div>
            ...
            <div className='hidden w-fit h-fit sm:flex flex-col items-center gap-4 absolute sm:left-[24vw] top-[38vh]  blur-sm z-0 '>
                ...
                <p className=' text-white w-[30ch] text-center'> {rotated[3]?.title} </p>
            </div>


            <button 
            onClick={skipper}
            className='w-fit z-40 bg-black text-primaryColor hover:text-white hover:bg-primaryColor border-2 border-[#777] rounded-3xl px-8 py-3 absolute bottom-8  '>
                Skip
            </button>
        </div>
    )
