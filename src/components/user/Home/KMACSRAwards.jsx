...
function KMACSRAwards() {
    return (
        <div className='flex mt-16 w-11/12 mx-auto max-md:flex-col'>
            <div className='w-full'>
                <h1 className='text-[2.8rem] max-md:text-[2.2rem] font-bold max-md:leading-[2.6rem]'>KMA CSR Awards
            ...
            <Image className='h-[580px] max-md:mt-6' src={image} alt='KMA CSR Awards' />
        </div>
    )
}
