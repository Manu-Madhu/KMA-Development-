    ...
    return (
        <div className='w-full mt-5 h-screen relative flex items-center justify-center'>
            <div className='w-fit flex flex-col items-center'>
                <h1 className='text-[2.4rem] font-bold leading-[3.5rem] text-center'>
                    Interested in Becoming a Member?
                </h1>
                <p>Click the register button below to see the procedures</p>
            ...
            <Image src={pattern2} alt='Pattern 2' className='absolute bottom-0 right-0 ' />
        </div>
    )
}
