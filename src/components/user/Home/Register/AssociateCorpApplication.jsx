...
const AssociateCorpApplication = ({handleSubmit,formData, handleChange,submitForm,isAvailable ,errors,usernameLoading,loading}) => {
  return (
...
export default AssociateCorpApplication
