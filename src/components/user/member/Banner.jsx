      ...
      <div className="relative">
        ...
        <div className="px-6 mb-10 max-w-screen-xl p-3 pt-10 mx-auto">
          <p className="text-base sm:text-sm text-justify opacity-80 leading-relaxed">
            ...
            participating
            <br /> in a variety of programmes like Lecture Meetings, Panel
            ...
            that
            <br /> are available to him for interaction with the managerial
            ...
            <br /> The current membership strength is over 1500, including about
