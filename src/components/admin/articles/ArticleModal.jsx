...
const ArticleModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className=" h-[450px] w-[250px]  md:w-[600px] pt-3 px-2 ">
     <div>
     <h1 className="text-lg mb-5 text-secondary">Add articles</h1>
      <IoClose
        onClick={onClose}
        size={23}
  ...
  <div>
    <div className="mb-3">
      ...
      <input type="text" className="form-input block w-full h-10 rounded-md border pl-3" placeholder="" id="exampleInputTitle" aria-describedby="titleHelp" />
    </div>
    <div className="mb-3">
      <label htmlFor="exampleInputcoverimage" className="block text-md font-medium text-customBlack-700">Speaker cover</label>
      <input type="text" className="form-input block w-full h-10 rounded-md border pl-3" placeholder="" id="exampleInputcoverimage" />
