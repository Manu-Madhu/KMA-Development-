...
const ArticleContent = () => {
    const galleryItems = [
        { id: 1, imageSrc: '/gallery/articleimg1.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 2, imageSrc: '/gallery/articleimg1.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 3, imageSrc: '/gallery/articleimg1.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 4, imageSrc: '/gallery/articleimg2.png', title: 'E-Book', description: '1Best New Poets' },
        { id: 5, imageSrc: '/gallery/articleimg2.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 6, imageSrc: '/gallery/articleimg2.png', title: 'E-Book', description: 'Best New Poets' },
