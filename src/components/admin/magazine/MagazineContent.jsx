...
const MagazineContent = () => {
    const galleryItems = [
        { id: 1, imageSrc: '/gallery/magazineimg1.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 2, imageSrc: '/gallery/magazineimg1.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 3, imageSrc: '/gallery/magazineimg1.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 4, imageSrc: '/gallery/magazineimg2.png', title: 'E-Book', description: '1Best New Poets' },
        { id: 5, imageSrc: '/gallery/magazineimg2.png', title: 'E-Book', description: 'Best New Poets' },
        { id: 6, imageSrc: '/gallery/magazineimg2.png', title: 'E-Book', description: 'Best New Poets' },
      ...
      {galleryItems.map(item => (
        <div key={item.id} className="relative mb-20">
          ...
          <div className="absolute inset-x-0 bottom-0 h-1/4  bg-customGray flex flex-col justify-end p-2 rounded-b-3xl ">
            ...
            <button className="absolute bg-[#FFFFFF] bg-opacity-90 right-4 py-2 px-4 rounded-full text-sm flex items-center mt-2">
