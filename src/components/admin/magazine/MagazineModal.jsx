...
const MagazineModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className=" h-[450px] w-[250px]  md:w-[600px] pt-3 px-2 ">
     <div>
     <h1 className="text-lg mb-5 text-secondary">Add magazine</h1>
      <IoClose
        onClick={onClose}
        size={23}
  ...
  <div>
    ...
    <div className="mb-3">
      ...
      <input type="text" className="form-input h-10 block w-full rounded-md border pl-3" placeholder="" id="exampleInputFile" />
      <button type="button" className="mt-2 px-4 py-2 rounded-md shadow-lg">browse</button>
